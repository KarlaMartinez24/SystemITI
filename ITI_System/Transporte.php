...
<head>
	...
	<!-- Theme JS files -->
	<script src="assets/js/plugins/editors/summernote/summernote.min.js"></script>
	...
	<script src="assets/js/demo_pages/editor_summernote.js"></script>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open"> 
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								<li class="nav-item"><a href="Transporte.php" class="nav-link active">Datos del Transporte</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Transporte</span> - Tickets</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_summernote.php" class="breadcrumb-item">Transporte</a>
					...
					<!-- Basic legend -->
						<div class="card">
							...
							<div class="card-body">
								<form action="#">
									<fieldset>
										<legend class="font-weight-semibold text-uppercase font-size-sm">Detalles del Transporte</legend>

										<div class="col-md-6">
										<div class="form-group">
											<label>Selecciona fecha de pago:</label>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<select data-placeholder="Selecciona tu horario" class="form-control form-control-select2" data-fouc>
													<option></option>
													<optgroup label="Disponibles">
														<option value="AK">7:00am</option>
														<option value="HI">9:00pm</option>
													</optgroup>
											...
											<div class="col-lg-9">
												<select data-placeholder="Selecciona tu horario" class="form-control form-control-select2" data-fouc>
													...
													<optgroup label="Disponibles">
														...
														<option value="HI">Tamatán</option>
													</optgroup>
									...
									<fieldset>
										<legend class="font-weight-semibold text-uppercase font-size-sm">Detalles Personales</legend>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="ITI">
										</div>
									</div>
