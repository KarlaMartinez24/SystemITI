...
<head>
	...
	<script src="assets/js/plugins/ui/fullcalendar/core/locales/ar.js"></script>
	<script src="assets/js/demo_pages/form_layouts.js"></script>

	<script src="assets/js/app.js"></script>
	<script src="assets/js/demo_pages/AgregarTutorias.js"></script>
	<script src="assets/js/demo_pages/form_input_groups.js"></script>
	<script src="assets/js/demo_pages/fullcalendar_advanced.js"></script>
	<!-- /theme JS files -->
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Content styling">
								<li class="nav-item"><a href="AgregarTutorias.php" class="nav-link active">Agregar una tutoría</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tutorías</span> - Agregar Tutorías</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="AgregarTutorias.php" class="breadcrumb-item">Tutorías</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar Tutoría</h5>
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Detalles de la tutoría</legend>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											...
											<input type="text" class="form-control" placeholder="1930030">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-lg-2 col-form-label">Carrera</label>
										<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre del maestro</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-user-tie"></i></span>
											</span>
											<input type="text" class="form-control" placeholder="Maestro">
										</div>
									</div>
								</div>		
										...
										<div class="col-md-3">
											<div class="mb-3" id="external-events">
												...
												<div class="fc-events-container mb-3">
													<div class="fc-event" data-color="#7CB342">Disponible</div>
													<div class="fc-event" data-color="#D32F2F">Ocupado</div>
													<div class="fc-event" data-color="#546E7A">No disponible</div>
												</div>
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary">Agregar Tutoría <i class="icon-paperplane ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
