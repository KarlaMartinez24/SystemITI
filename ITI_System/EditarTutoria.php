					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Content styling">
								...
								<li class="nav-item"><a href="EditarTutoria.php" class="nav-link active">Editar una tutoría</a></li>
							</ul>
						</li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tutorías</span> - Editar Tutoría</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="content_cards.php" class="breadcrumb-item">Tutorías</a>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-danger">
								<h6 class="modal-title">Eliminar tutoría</h6>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>

							<div class="modal-body">
								
								<p>¿Estás seguro de que deseas eliminar ésta tutoría?</p>
								<p>De ser así, necesitamos tu nombre y contraseña para confirmarlo.</p>
								<p></p>
								<p></p>
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="023" class="form-control">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Diana Gabriela Gonzáles Reyes" class="form-control">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Tecnologías de la Información" class="form-control">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder="Mario Rodriguez" data-mask="+99-99-9999-9999" class="form-control">
											
										</div>
									</div>

									<div class="form-group row">
										<label class="col-form-label col-sm-3">Tema</label>
										<div class="col-sm-9">
											<input type="text" placeholder="DigitanOcean" class="form-control">
										</div>
									</div>

									<div class="form-group row">
										<label class="col-form-label col-sm-3">Fecha y Hora</label>
										<div class="col-sm-9">
											<span class="input-group-prepend">
												<span class="input-group-text"><i class="icon-calendar3"></i></span>
											</span>
											<input type="text" class="form-control" id="anytime-both" value="Oct 25 08:30">
										</div>
									</div>
				...
				<!-- Basic datatable -->
					<div class="card">
						<div class="card-header header-elements-inline">
							<h5 class="card-title">Editar Tutoría </h5>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								<td>023</td>
								<td>Diana Gabriela González Reyes</td>
								<td>Tecnologías de la Información</td>
								<td>1930035</td>
								<td>Mario Rodriguez</td>
								<td>DigitanOcean</td>
								<td><span class="badge badge-success">9:00 am</span></td>
							...
							<tr>
								<td>029</td>
								<td>Cielo Merari Pulido Quintanilla</td>
								
								<td>Administración y Gestión Empresarial</td>
								<td>1930056</td>
								<td>Marta Rodriguez</td>
								<td>Gestación Empresarial</td>
								<td><span class="badge badge-success">11:00 am</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
							...
							<tr>
								<td>034</td>
								<td>Nathalie Perez Monrreal</td>
								<td>Mecatrónica</td>
								<td>1930343</td>
								<td>Érendira Sanchez</td>
								<td>Álgebra</td>
								
								<td><span class="badge badge-success">8:00 am</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
